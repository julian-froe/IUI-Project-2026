...
export default function RecipeCard({ recipe }: RecipeCardProps) {
  return (
    <Link to={`/recipe/${recipe.id}`} className="group block relative overflow-hidden bg-white data-[hand-hover=true]:bg-neutral-50 transition-colors">
      <div className="aspect-[4/5] overflow-hidden grayscale group-hover:grayscale-0 group-data-[hand-hover=true]:grayscale-0 transition-all duration-700">
        <motion.img
      ...
      <div className="mt-6 space-y-3 px-1">
        ...
        <div className="pt-4">
          <div className="h-[1px] w-full bg-black/10 group-hover:bg-black group-data-[hand-hover=true]:bg-black transition-colors" />
        </div>
      </div>
    </Link>
  );
